...
interface BuilderTempState {
    items: LabelAPI[] | any;
    text: string;
    type: LabelTypes;
};

interface BuilderTempProps {
    items: Item[];
};

export default class BuilderTemp extends React.Component<BuilderTempProps, BuilderTempState> {
    constructor(props: Readonly<BuilderTempProps>) {
        super(props);
        this.state = {
            items: [],
            text: '',
